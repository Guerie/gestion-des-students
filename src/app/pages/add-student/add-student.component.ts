...
export class AddStudentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.studentForm = this.fb.group(
      {
        nom: [' ', Validators.compose([Validators.required, Validators.minLength(5)])],
        prenom: [' ', Validators.compose([Validators.required, Validators.minLength(5)])],
        adresse: [' ', Validators.compose([Validators.required, Validators.minLength(5)])],
    }
    );
  }
  public add() {
